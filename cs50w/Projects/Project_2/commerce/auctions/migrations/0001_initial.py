    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('FAS', 'Fashion'), ('TEC', 'Technology'), ('HOU', 'Household'), ('ENT', 'Entertainment'), ('CHI', 'Children'), ('F&B', 'Food & Beverage'), ('H&W', 'Health & Wellness'), ('OTH', 'Others')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(auto_now_add=True)),
                ('comment_item', models.ManyToManyField(blank=True, related_name='comment_item', to='auctions.listing')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(auto_now_add=True)),
                ('bid_item', models.ManyToManyField(blank=True, related_name='bid_item', to='auctions.listing')),
